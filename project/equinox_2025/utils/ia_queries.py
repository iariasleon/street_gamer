...
from project.equinox_2025.utils.geo import localiza_poblacion
...
def city_quiz_ia(lat, lon):
    ...
    client = OpenAI(
        api_key="XXX" ) # Reemplaza con tu clave de API de OpenAI)
    ...
    city_quiz = response.choices[0].message.content
